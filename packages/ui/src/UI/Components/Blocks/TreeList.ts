...
export class TreeList<BlockT extends TreeList.BlockItem> extends Block {
    ...
    public static withItems<T extends TreeList<TreeList.BlockItem>>(
        this: { new (): T, with: typeof TreeList.with },
    ...
    public readonly SelectionChange: ComponentSignal.Emittable<TreeList.ItemEvent<BlockT>, typeof TreeList.SelectionSignal> = this.defineComponentSignal(TreeList.SelectionSignal);

    /** Signal emitted when a tree list item is collapsed, while displayed on screen */
    public readonly ItemCollapsed = this.defineComponentSignal(TreeList.FoldSignal);

    /** Signal emitted when a tree list item is expanded, while displayed on screen */
    public readonly ItemExpanded = this.defineComponentSignal(TreeList.FoldSignal);
...
export class TreeListSelectionHandler<T extends TreeList.BlockItem>
    extends ComponentSignalHandler<TreeList.ItemEvent<T>, typeof TreeList.SelectionSignal> { }
...
export class TreeListFoldHandler<T extends TreeList.BlockItem>
    extends ComponentSignalHandler<TreeList.ItemEvent<T>, typeof TreeList.FoldSignal> { }
