...
export class UIScrollContainer extends UIContainer {
    static preset(presets: UIScrollContainer.Presets,
...
UIScrollContainer.observe(class {
    constructor(public container: UIScrollContainer) { }
    onScroll(e: UIScrollEvent) {
        if (!this.container.horizontalSnap &&
            !this.container.verticalSnap)
            return;
