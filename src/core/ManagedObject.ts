...
export class ManagedObject {
    ...
    static handle<T extends ManagedObject>(
        this: ManagedObjectConstructor<T>, h: any) {
     ...
     * @note This property _cannot_ be observed directly. Observer classes (see `ManagedObject.observe`) should use methods such as `onActive` to observe lifecycle state.
     */
     ...
     */
    public emit<TEvent extends ManagedEvent = ManagedEvent, TConstructorArgs extends any[] = any[]>(
    ...
    protected propagateChildEvents(
        f?: ((this: this, e: ManagedEvent, propertyName: string) => ManagedEvent | ManagedEvent[] | undefined | void)): this;
    /**
     ...
     * @note Calling this method a second time _replaces_ any existing propagation rule entirely.
     */
    protected propagateChildEvents(...types: Array<ManagedEvent | { new(...args: any[]): ManagedEvent }>): this;
    protected propagateChildEvents(...types: any[]) {
        let firstIsFunction = types[0] &&
    ...
    private _transitionManagedState(newState: ManagedState, callback: () => undefined | Promise<any>,
        event: ManagedEvent, callbackAfter?: () => undefined | Promise<any>) {
    ...
    static createManagedReferenceProperty<T extends ManagedObject>(
        ...
        if (Object.getOwnPropertyDescriptor(object, propertyKey)) {
            throw Error("[Object] Cannot turn properties with getters and/or setters into managed references");
        }
