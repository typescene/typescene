...
declare class Map { get: any; set: any; forEach: any; delete: any; };
...
export class ObservableArray<T> {
    ...
    static fromObservableValue<T>(observableValue: ObservableValue<T[] | T | undefined>, lazy?: boolean):
        ObservableArray<T> {
        ...
        if (!lazy) unobserved(() => result.length);
    ...
    public mapAsync<U>(callback: (value: T, index: number, array: T[]) =>
        (ObservableValue<U> | U), thisArg?: any,
        lazy?: boolean): ObservableArray<U> {
    ...
    public mapAsyncValues<U>(callback: (value: T) => (ObservableValue<U> | U),
        thisArg?: any, lazy?: boolean): ObservableArray<U> {
        ...
        return this.mapAsync((v, i) => {
            ...
            var o = callback.call(thisArg || this, v);
            _add(defv, o);
            return o;
        }, undefined, lazy);
    }
    ...
    public flattenAsync(removeGaps?: boolean, lazy?: boolean) {
