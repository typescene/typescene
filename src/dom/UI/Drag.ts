...
import { Component, Drag, Style } from "@typescene/core/UI";
...
class DOMDrag extends Drag {
    ...
    public pickUp(component: Component, removeWhenDone?: boolean) {
        ...
        var override: Style = (<any>component)["@_DOMDrag_Override"];
        if (!override) {
            override = (<any>component)["@_DOMDrag_Override"] = new Style({
                position: "fixed",
